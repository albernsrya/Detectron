...
_DATASETS = {
    "cityscapes_fine_instanceonly_seg_train": {
        _IM_DIR: _DATA_DIR + "/cityscapes/images",
        _ANN_FN: _DATA_DIR + "/cityscapes/annotations/instancesonly_gtFine_train.json",
        _RAW_DIR: _DATA_DIR + "/cityscapes/raw",
    },
    ...
    "cityscapes_fine_instanceonly_seg_test": {
        _IM_DIR: _DATA_DIR + "/cityscapes/images",
        _ANN_FN: _DATA_DIR + "/cityscapes/annotations/instancesonly_gtFine_test.json",
        _RAW_DIR: _DATA_DIR + "/cityscapes/raw",
    },
    "coco_2014_train": {
        _IM_DIR: _DATA_DIR + "/coco/coco_train2014",
        _ANN_FN: _DATA_DIR + "/coco/annotations/instances_train2014.json",
    },
    "coco_2014_val": {
        _IM_DIR: _DATA_DIR + "/coco/coco_val2014",
    ...
    "coco_2015_test": {
        _IM_DIR: _DATA_DIR + "/coco/coco_test2015",
    ...
    "coco_stuff_train": {
        _IM_DIR: _DATA_DIR + "/coco/coco_train2014",
        _ANN_FN: _DATA_DIR + "/coco/annotations/coco_stuff_train.json",
    },
    "coco_stuff_val": {
        _IM_DIR: _DATA_DIR + "/coco/coco_val2014",
        _ANN_FN: _DATA_DIR + "/coco/annotations/coco_stuff_val.json",
    },
    "keypoints_coco_2014_train": {
        _IM_DIR: _DATA_DIR + "/coco/coco_train2014",
        _ANN_FN: _DATA_DIR + "/coco/annotations/person_keypoints_train2014.json",
    },
    "keypoints_coco_2014_val": {
        _IM_DIR: _DATA_DIR + "/coco/coco_val2014",
        _ANN_FN: _DATA_DIR + "/coco/annotations/person_keypoints_val2014.json",
    },
    "keypoints_coco_2014_minival": {
        _IM_DIR: _DATA_DIR + "/coco/coco_val2014",
        _ANN_FN: _DATA_DIR + "/coco/annotations/person_keypoints_minival2014.json",
    },
    ...
    "voc_2007_train": {
        _IM_DIR: _DATA_DIR + "/VOC2007/JPEGImages",
        _ANN_FN: _DATA_DIR + "/VOC2007/annotations/voc_2007_train.json",
        _DEVKIT_DIR: _DATA_DIR + "/VOC2007/VOCdevkit2007",
    },
    "voc_2007_val": {
        _IM_DIR: _DATA_DIR + "/VOC2007/JPEGImages",
        _ANN_FN: _DATA_DIR + "/VOC2007/annotations/voc_2007_val.json",
        _DEVKIT_DIR: _DATA_DIR + "/VOC2007/VOCdevkit2007",
    },
    "voc_2007_test": {
        _IM_DIR: _DATA_DIR + "/VOC2007/JPEGImages",
        _ANN_FN: _DATA_DIR + "/VOC2007/annotations/voc_2007_test.json",
        _DEVKIT_DIR: _DATA_DIR + "/VOC2007/VOCdevkit2007",
    },
    "voc_2012_train": {
        _IM_DIR: _DATA_DIR + "/VOC2012/JPEGImages",
        _ANN_FN: _DATA_DIR + "/VOC2012/annotations/voc_2012_train.json",
        _DEVKIT_DIR: _DATA_DIR + "/VOC2012/VOCdevkit2012",
    },
    "voc_2012_val": {
        _IM_DIR: _DATA_DIR + "/VOC2012/JPEGImages",
        _ANN_FN: _DATA_DIR + "/VOC2012/annotations/voc_2012_val.json",
        _DEVKIT_DIR: _DATA_DIR + "/VOC2012/VOCdevkit2012",
    },
}
